...
zhSetLogger({
    debug(message, namespace) { logger.debug(`${message}`, { namespace }) },
    error(message, namespace) { logger.error(`${message}`, { namespace }) },
    info(message, namespace) { logger.info(`${message}`, { namespace }) },
