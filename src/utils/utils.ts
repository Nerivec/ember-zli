...
export const browseToFile = async (message: string, defaultValue: string, toWrite = false): Promise<string> => {
...
export const computeCRC16 = (data: Buffer, init = 0): Buffer => {
    let crc = init;
...
export const computeCRC16CITTKermit = (data: Buffer, init = 0): Buffer => {
    let crc = init;
